package uk.mach91.autoalarm.aboutdialog;
...
public class AboutPage {
     ...
     * @param context
     */
    public AboutPage(Context context, int textColor, int textColorHighlight) {
        this.mContext = context;

        mTextColorPrimary = textColor;
        mTextColorHighlight = textColorHighlight;
        ...
        layout.setBackgroundColor(getColorFromThemeAttr(mContext, R.attr.colorPrimary));
        mView.setBackgroundColor(getColorFromThemeAttr(mContext, R.attr.colorPrimary));
    ...
    public AboutPage addGroup(String name) {
        ...
        textView.setTextColor(mTextColorHighlight);
    ...
    public View create() {
        ...
        description.setBackgroundColor(getColorFromThemeAttr(mContext, R.attr.colorPrimary));
        description.setTextColor(mTextColorPrimary);
        image.setBackgroundColor(getColorFromThemeAttr(mContext, R.attr.colorPrimary));
    ...
    private View createItem(final Element element) {
        ...
        wrapper.setBackgroundColor(getColorFromThemeAttr(mContext, R.attr.colorPrimary));
        ...
        LinearLayout.LayoutParams textParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        textView.setLayoutParams(textParams);
        textView.setTextColor(mTextColorPrimary);
