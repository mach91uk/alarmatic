...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "uk.mach91.autoalarm.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "uk.mach91.autoalarm.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "uk.mach91.autoalarm.extra.ID";
...
//    private NotificationCompat.Builder mNoteBuilder;
     ...
     */
    private final SimpleArrayMap<Long, Notification.Builder> mNoteBuilders = new SimpleArrayMap<>();
