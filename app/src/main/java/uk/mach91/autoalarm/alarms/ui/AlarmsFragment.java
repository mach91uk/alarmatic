...
import uk.mach91.autoalarm.alarms.data.AlarmsListCursorLoader;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "uk.mach91.autoalarm.alarms.extra.SCROLL_TO_ALARM_ID";
