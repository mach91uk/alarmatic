...
import uk.mach91.autoalarm.data.DatabaseTableManager;
import uk.mach91.autoalarm.alarms.Alarm;
import uk.mach91.autoalarm.data.DatabaseTableManager;

import uk.mach91.autoalarm.data.DatabaseTableManager;

import static uk.mach91.autoalarm.alarms.misc.DaysOfWeek.FRIDAY;
import static uk.mach91.autoalarm.alarms.misc.DaysOfWeek.MONDAY;
import static uk.mach91.autoalarm.alarms.misc.DaysOfWeek.SATURDAY;
import static uk.mach91.autoalarm.alarms.misc.DaysOfWeek.SUNDAY;
import static uk.mach91.autoalarm.alarms.misc.DaysOfWeek.THURSDAY;
import static uk.mach91.autoalarm.alarms.misc.DaysOfWeek.TUESDAY;
import static uk.mach91.autoalarm.alarms.misc.DaysOfWeek.WEDNESDAY;
...
public class AlarmsTableManager extends DatabaseTableManager<Alarm> {
    ...
    protected ContentValues toContentValues(Alarm alarm) {
        ...
        values.put(AlarmsTable.COLUMN_SKIP_HOLIDAY, alarm.skip_holiday());
